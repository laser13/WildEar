...
// Generated by Material Theme Builder from seed #FFDE3F.
// Standard contrast — light + dark. Medium/high-contrast variants omitted.

/** iNaturalist brand green — used consistently across Home, Review, and SpeciesDetails. */
val iNatGreen = Color(0xFF74AC00)

// Semantic tints for detected-species cards in live recording and review screens.
// Light Green 100 (warm yellow-green) reads as natural foliage instead of the
// cooler tertiaryContainer (which leans cyan in this amber-seed palette).
val detectionCardLikelyLight = Color(0xFFDCEDC8) // fresh-leaf warm green
val detectionCardUnlikelyLight = Color(0xFFFFDAD6) // same as errorContainerLight
